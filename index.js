...
function logArrayElements(arr) {
  ...
  arr.forEach((newArr, index) => {
    console.log("Елемент " + index + ":", newArr)
  })
}
...
function validateUserInput(userInput) {
  ...
  if (!console.assert(!userInput.password.length < 8)) {
...
function countVowelsAndConsonants(word) {
  ...
  for (let letter of word) {
   ...
   if (str.includes(letter)){
    console.count("Golosna")
   }  
   else {
    console.count("Prygolosna")
   }
   console.count(letter)  
  }
  console.countReset("Golosna")
  console.countReset("Prygolosna")
